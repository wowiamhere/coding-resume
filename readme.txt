...
*Ruby on Rails
	-shopping web blog (website) monetized through affiliate marketing.
	-web store to connect with shopping web blog (above)
	-HTML, CSS, ANGULAR, POSTGRESQL
 *Game Development
	-C++
	-SFML
